...
class AreaRangoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'rango_6_descripcion'  => 'nullable|string|max:150',
            'rango_6_minimo'       => 'nullable|numeric',
            'rango_6_maximo'       => 'nullable|numeric',
            'rango_7_descripcion'  => 'nullable|string|max:150',
            'rango_7_minimo'       => 'nullable|numeric',
            'rango_7_maximo'       => 'nullable|numeric',
            'rango_8_descripcion'  => 'nullable|string|max:150',
            'rango_8_minimo'       => 'nullable|numeric',
            'rango_8_maximo'       => 'nullable|numeric',
