<style>
    ...
    th{ background:#f2f2f2; font-weight:700; font-size: 9px; }
...
{{--<div class="hr"></div>--}}
<table class="form-grid" style="margin-top:120px;">
    <tr>
    ...
    <tr>
        ...
        <td colspan="2"><span class="label">SERVICIO/SERVICIO/SALA/CAMA:</span></td>
